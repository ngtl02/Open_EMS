		...
		return new ModbusProtocol(this,
				...
				new FC4ReadInputRegistersTask(5003, Priority.LOW,
						m(PvInverterSungrow.ChannelId.ACTIVE_PRODUCTION_ENERGY_DAILY,
								new UnsignedWordElement(5003), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.ACTIVE_PRODUCTION_ENERGY_TOTAL,
								new SignedDoublewordElement(5004)),
						new DummyRegisterElement(5006, 5007),
						m(PvInverterSungrow.ChannelId.TEMPERATURE,
								new SignedDoublewordElement(5008)),
						new DummyRegisterElement(5009, 5010),
						m(PvInverterSungrow.ChannelId.DC1_AMPERE,
								new UnsignedWordElement(5011), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC1_VOLTAGE,
								new UnsignedWordElement(5012), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC2_AMPERE,
								new UnsignedWordElement(5013), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC2_VOLTAGE,
								new UnsignedWordElement(5014), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC3_AMPERE,
								new UnsignedWordElement(5015), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC3_VOLTAGE,
								new UnsignedWordElement(5016), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC_TOTAL,
								new UnsignedDoublewordElement(5017), SCALE_FACTOR_MINUS_3),
						m(ElectricityMeter.ChannelId.VOLTAGE_L1,
								new UnsignedWordElement(5019), SCALE_FACTOR_1),
						m(ElectricityMeter.ChannelId.VOLTAGE_L2,
								new UnsignedWordElement(5020), SCALE_FACTOR_1),
						m(ElectricityMeter.ChannelId.VOLTAGE_L3,
								new UnsignedWordElement(5021), SCALE_FACTOR_1),
						m(ElectricityMeter.ChannelId.CURRENT_L1,
								new UnsignedWordElement(5022), SCALE_FACTOR_1),
						m(ElectricityMeter.ChannelId.CURRENT_L2,
								new UnsignedWordElement(5023), SCALE_FACTOR_1),
						m(ElectricityMeter.ChannelId.CURRENT_L3,
								new UnsignedWordElement(5024), SCALE_FACTOR_1),
						new DummyRegisterElement(5025, 5030),
						m(ElectricityMeter.ChannelId.ACTIVE_POWER,
								new UnsignedDoublewordElement(5031).wordOrder(WordOrder.MSWLSW), SCALE_FACTOR_3),
						m(ElectricityMeter.ChannelId.REACTIVE_POWER,
								new SignedDoublewordElement(5033).wordOrder(WordOrder.MSWLSW), SCALE_FACTOR_3),
						m(PvInverterSungrow.ChannelId.PF,
								new SignedWordElement(5035), SCALE_FACTOR_1),
						m(ElectricityMeter.ChannelId.FREQUENCY,
								new SignedDoublewordElement(5036).wordOrder(WordOrder.MSWLSW), SCALE_FACTOR_1)),
				new FC4ReadInputRegistersTask(5115, Priority.HIGH,
						m(PvInverterSungrow.ChannelId.DC4_AMPERE,
								new UnsignedWordElement(5115), SCALE_FACTOR_1),
						m(PvInverterSungrow.ChannelId.DC4_VOLTAGE,
								new UnsignedWordElement(5116), SCALE_FACTOR_1)),
