...
public class PvInverterSMAHybridImpl extends AbstractOpenemsModbusComponent
	...
	protected ModbusProtocol defineModbusProtocol() {
		return new ModbusProtocol(this,
				...
				new FC3ReadRegistersTask(30901, Priority.HIGH,
						m(ElectricityMeter.ChannelId.FREQUENCY,
								new UnsignedDoublewordElement(30901).wordOrder(WordOrder.MSWLSW),
				...
				new FC3ReadRegistersTask(30953, Priority.HIGH,
						...
						// m(PvInverterSMAHybrid.ChannelId.STATUS_BATTERY,
						// new SignedDoublewordElement()),
