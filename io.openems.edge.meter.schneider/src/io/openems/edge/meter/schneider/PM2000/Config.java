...
@ObjectClassDefinition(//
		name = "Meter Schneider 2000 Series", //
		description = "Implements the Schneider 2000 Series power meter.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Meter Schneider 2000 Series [{id}]";
}