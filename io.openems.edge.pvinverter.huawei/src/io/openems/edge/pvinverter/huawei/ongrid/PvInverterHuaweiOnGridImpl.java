...
import io.openems.edge.pvinverter.huawei.hybrid.PvInverterHuaweiHybrid;
//import io.openems.edge.pvinverter.huawei.ongrid.PvInverterHuaweiOnGrid;
...
@Component(//
		name = "PV-Inverter.Huawei.OnGrid", //
		immediate = true, //
...
public class PvInverterHuaweiOnGridImpl extends AbstractOpenemsModbusComponent
		implements PvInverterHuaweiOnGrid, ManagedSymmetricPvInverter, ElectricityMeter, ModbusComponent,
		OpenemsComponent,
	...
	public PvInverterHuaweiOnGridImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				ElectricityMeter.ChannelId.values(), //
				ManagedSymmetricPvInverter.ChannelId.values(), //
				PvInverterHuaweiOnGrid.ChannelId.values() //
		);
	}
		...
		switch (event.getTopic()) {
			case EdgeEventConstants.TOPIC_CYCLE_EXECUTE_WRITE:
				try {
					...
					this.channel(PvInverterHuaweiOnGrid.ChannelId.PV_LIMIT_FAILED).setNextValue(false);
				} catch (OpenemsNamedException e) {
					this.channel(PvInverterHuaweiOnGrid.ChannelId.PV_LIMIT_FAILED).setNextValue(true);
				}
				break;
