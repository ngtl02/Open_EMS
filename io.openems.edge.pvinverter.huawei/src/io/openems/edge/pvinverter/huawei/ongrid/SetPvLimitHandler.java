...
public class SetPvLimitHandler implements ThrowingRunnable<OpenemsNamedException> {
	...
	private final PvInverterHuaweiOnGridImpl parent;
	...
	public SetPvLimitHandler(PvInverterHuaweiOnGridImpl parent, ManagedSymmetricPvInverter.ChannelId activePowerLimit) {
		this.parent = parent;
	...
	public void run() throws OpenemsNamedException {
		...
		if (percentOpt.isPresent()) {
			// EVN sent PERCENT - use it directly
